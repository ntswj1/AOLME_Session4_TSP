...
total_distance = total_distance + move('dog', 15, 40, 'right', 'down')
scene.add_frame()

total_distance = total_distance + move('dog', 17, 40, 'right', 'down')
scene.add_frame()

total_distance = total_distance + move('dog', 50, 10, 'left', 'down')
scene.add_frame()

total_distance = total_distance + move('dog', 45, 12, 'left', 'down')
scene.add_frame()

total_distance = total_distance + move('dog', 70, 15, 'left', 'up')
scene.add_frame()

total_distance = total_distance + move('dog', 70, 20, 'left', 'up')
scene.add_frame()
